...
if [[ -n "$URL" ]]; then
    ...
    ffmpeg -reconnect 1 -reconnect_at_eof 1 -reconnect_streamed 1 -reconnect_delay_max 5 -i "$URL" -t 1800 -acodec mp3 "$OUTPUT_FILE" > /home/dnlab/Log/mbc-economic.log 2>&1 &
